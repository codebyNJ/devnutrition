...
> = {
  ...
  DevNutrition: {
    active: "Auditing developer nutrition",
    done: "Audited developer nutrition for 2.1s",
    rows: [
      { primary: "Measuring commit churn & sleep deprivation…" },
      { primary: "Calculating saturated technical debt…" },
      { primary: "Auditing Stack Overflow dependencies…", secondary: "3 sources" },
    ],
  },
  Coding: {
