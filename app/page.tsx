 ...
 * what sequences the run. RUN_MS is when the trace has had its say; CLOSE_MS
 * is the fade before the label takes the stage. */
...
export default function Page() {
  ...
  const inspect = useCallback(
    async (raw: string) => {
      ...
      const data = analyze(login, await fetchUser(login));
